...
#Region "OU Related Functions"
    ...
    ''' Uses the AuthenticationIsSet Function as an option for elevated access
    ''' </remarks>
    Function MoveUserToNewOU(Username As String, NewPath As String, Optional ByRef Err_MSG As String = "", Optional Simulate As Boolean = False, Optional Simulate_Return As Boolean = False) As Boolean
    ...
    ''' </summary>
    Public Function GetOUChildren(sLDAP As String, Optional ByVal Username As String = "", Optional ByVal Password As String = "") As Collection
    ...
    ''' </summary>
    Public Function GetOUStreet(sLDAP As String, OUName As String, Optional ByVal Username As String = "", Optional ByVal Password As String = "", Optional ByRef ErrMsg As String = "") As String
        Dim sAns As String = ""
        Try
...
#Region "User Related Functions"
    ...
    ''' </summary>
    Public Sub AddUserToGroup2(deGroup As DirectoryEntry, user As DirectoryEntry)
        deGroup.RefreshCache()
    ...
    ''' </remarks>
    Public Sub adUserToGroup(ByVal sGroupName As String, sUserComputerName As String, Optional ByVal Username As String = "", Optional ByVal Password As String = "")
        Dim Buf As String = ""
    ...
    ''' </summary>
    Public Sub AddUserToADGroup(sUser As String, sGroup As String, Optional ByVal ErrMsg As String = "")
        Try
    ...
    ''' </summary>
    Public Sub DeleteUserFromADGroup(sUser As String, sGroup As String)
        Dim ctx As New System.DirectoryServices.AccountManagement.PrincipalContext(ContextType.Domain)
        Dim mygroup As GroupPrincipal = GroupPrincipal.FindByIdentity(ctx, sGroup)
    ...
    ''' <remarks></remarks>
    Public Sub DeleteDomainUserFromRemoteGroup(sUser As String, sGroup As String, sComputer As String, Optional sDomain As String = "", Optional ByRef ErrMsg As String = "")
        Try
...
#Region "Active Directory Group Related Functions"
    ...
    ''' </summary>
    Public Function ADGroupExists(sGroupName As String) As Boolean
        Dim bAns As Boolean = False
        Try
            Dim ctx As New System.DirectoryServices.AccountManagement.PrincipalContext(ContextType.Domain)
    ...
    ''' </summary>
    Public Sub CreateADGroup(sNewGroupName As String, sParentOU As String, Optional ByVal sDesc As String = "")
        Dim dom As New DirectoryEntry()
    ...
    ''' </summary>
    Public Sub DeleteADGroup(sGroupName As String)
        Dim ctx As New System.DirectoryServices.AccountManagement.PrincipalContext(ContextType.Domain)
        Dim mygroup As GroupPrincipal = GroupPrincipal.FindByIdentity(ctx, sGroupName)
        mygroup.Delete()
        mygroup.Save()
...
#Region "Other Functions for AD and What not"
    ...
    ''' </summary>
    Private Function ADSIObject_EnumToString(iValue As ADSIObject) As String
        Dim sAns As String = ""
        Select Case iValue
            Case 1
                sAns = "Class"
    ...
    ''' </summary>
    Function FindObject(samAccountName As String, Optional ByVal sAccountType As AD_AccountType = AD_AccountType.USER, Optional ByRef ErrorMessage As String = "") As String
        Dim sAns As String = ""
    ...
    ''' </summary>
    Private Function TrimADCrap(sValue As String) As String
        Dim sAns As String = ""
    ...
    ''' </summary>
    Public Function isAllowedToUseApp(iGroup As String, AdminGRoupName As String) As Boolean
        Dim bAns As Boolean = False
